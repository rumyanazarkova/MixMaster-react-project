...
const NewsLetter = () => {
    ...
    return <Form className="form" method="POST">
        ...
        <div className="form-row">
            ...
            <input type="text" className="form-input" name="name" id="name" required defaultValue="john" />
        </div>
        <div className="form-row">
            <label htmlFor="lastName" className="form-label">last name</label>
            <input type="text" className="form-input" name="lastName" required id="lastName" defaultValue="doe" />
        </div>
        <div className="form-row">
